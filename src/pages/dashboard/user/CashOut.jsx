...
const CashOut = () => {
    ...
    const totalAmount = amountValue +(amountValue*0.015);
      const pin = data.pin;
      const sender = {
        ...user,
        timeStamp: new Date(),
    ...
    return (
        ...
        <div className="flex flex-col max-w-xl w-full p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900">
          <div className="mb-8 text-center">
            ...
            Cash Out your money on anytime, any where in the World
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  id="email"
                  required
                  placeholder="Enter Agent Email or Mobile (with 880) Here To CashOut"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-[#2DBE61] bg-gray-200 text-gray-900"
                  {...register("amount", {max: user?.balance }, { required: true })}
                />
                {/* errors will return when field validation fails  */}
                {errors.amount && (

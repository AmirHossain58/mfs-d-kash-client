...
const CashIn = () => {
    ...
    //   setLoading(true)
      ...
      try {
        ...
        if (res?.insertedId) {
          refetch()
          toast.success("Cash-in Request  Send Successfully");
          reset()
        //   navigate(from);
        }
        // setLoading(false);
    ...
    return (
        ...
        <Helmet>
          <title>D-Kash | Cash In</title>
        </Helmet>
        <div className="flex flex-col max-w-xl w-full p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900">
          <div className="mb-8 text-center">
            <h1 className="my-3 text-4xl font-bold">Cash In</h1>
            <p className="text-sm text-gray-400">
              Send a Cash In Request to Agent
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  id="email"
                  required
                  placeholder="Enter Agent Email or Mobile (with 880) Here To Cash In"
